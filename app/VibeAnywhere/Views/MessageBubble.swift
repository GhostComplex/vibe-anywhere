...
/// A separate view that observes ONLY the StreamingState object.
/// Because StreamingState is @ObservationIgnored on ChatViewModel,
/// chunk updates here never cause ForEach to diff the messages array.
